...
exports.visualStudioDarkBackgroundColor = exports.themes = void 0;
const oceanicNext = __importStar(require("monaco-themes/themes/Oceanic Next.json"));
const blackboard = __importStar(require("monaco-themes/themes/Blackboard.json"));
const cloudsMidnight = __importStar(require("monaco-themes/themes/Clouds Midnight.json"));
const merbivore = __importStar(require("monaco-themes/themes/Merbivore.json"));
const monokai = __importStar(require("monaco-themes/themes/Monokai.json"));
const nightOwl = __importStar(require("monaco-themes/themes/Night Owl.json"));
const tomorrowNight = __importStar(require("monaco-themes/themes/Tomorrow-Night.json"));
exports.themes = [
...
exports.visualStudioDarkBackgroundColor = '#1e1e1e';
function getOneDark() {
